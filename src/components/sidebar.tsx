      ...
      <nav className="flex-1 p-3 space-y-4 overflow-y-auto">
        ...
        <div>
          ...
          <div className="space-y-0.5">
            <Link
              href="/"
              className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm bg-cyan-50 dark:bg-cyan-900/20 text-cyan-600 dark:text-cyan-400 font-medium border border-cyan-100 dark:border-cyan-800"
            >
            ...
            <Link
              href="/all"
              className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
